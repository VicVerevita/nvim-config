...
vim.keymap.set('n', '<leader>6', function() harpoon_ui.nav_file(6) end, opts)
vim.keymap.set('n', '<leader>7', function() harpoon_ui.nav_file(7) end, opts)
vim.keymap.set('n', '<leader>8', function() harpoon_ui.nav_file(8) end, opts)
vim.keymap.set('n', '<leader>9', function() harpoon_ui.nav_file(9) end, opts)
